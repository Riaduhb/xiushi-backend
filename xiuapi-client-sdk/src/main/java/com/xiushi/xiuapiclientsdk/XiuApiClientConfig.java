package com.xiushi.xiuapiclientsdk;
...
@ConfigurationProperties("xiushi.client")
// @Data 注解是一个 Lombok 注解,自动生成了类的getter、setter方法
@Data
// @ComponentScan 注解用于自动扫描组件，使得 Spring 能够自动注册相应的 Bean
@ComponentScan
public class XiuApiClientConfig {
    private String accessKey;

    private String secretKey;

    @Bean
    public XiuApiClient yuApiClient() {
        return new XiuApiClient(accessKey,secretKey);
    }
}
